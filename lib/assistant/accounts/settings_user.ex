defmodule Assistant.Accounts.SettingsUser do
  use Ecto.Schema
  ...
  @doc """
  A settings_user changeset for registering or changing the email.
  ...
  ## Options
    ...
    * `:validate_unique` - Set to false if you don't want to validate the
      ...
      Defaults to `true`.
  """
  def email_changeset(settings_user, attrs, opts \\ []) do
    settings_user
    |> cast(attrs, [:email])
    |> validate_email(opts)
  end
  ...
  @doc """
  A settings_user changeset for profile updates.
  """
  ...
  defp validate_email(changeset, opts) do
    ...
    if Keyword.get(opts, :validate_unique, true) do
      changeset
      |> unsafe_validate_unique(:email, Assistant.Repo)
  ...
  @doc """
  A settings_user changeset for changing the password.
  ...
  ## Options
    ...
    * `:hash_password` - Hashes the password so it can be stored securely
      ...
      Defaults to `true`.
  """
  def password_changeset(settings_user, attrs, opts \\ []) do
    settings_user
    |> cast(attrs, [:password])
  ...
  """
  def valid_password?(
        %Assistant.Accounts.SettingsUser{hashed_password: hashed_password},
        password
      )
