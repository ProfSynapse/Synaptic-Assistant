      ...
      parameters: %{
        ...
        "properties" => %{
          ...
          "skills" => %{
            "type" => "array",
            "items" => %{"type" => "string"},
            "description" => "List of skill names the agent can use (e.g., ['search_tasks', 'send_email']). Agent only sees these skills."
          },
          "context" => %{
            "type" => "string",
...
%{
  ...
  tool_calls: [%{
    ...
    function: %{
      name: "dispatch_agent",
      arguments: ~s({"agent_id": "task_search", "mission": "...", "skills": ["search_tasks"]})
    }
  }]
}
