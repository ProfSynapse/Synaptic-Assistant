...
defmodule Assistant.Skills.Tasks.Get do
  ...
  def tool_definition do
    %{
      name: "tasks.get",
      description: "Get full details of a specific task including subtasks, comments, dependencies, and change history.",
      parameters: %{
        "type" => "object",
        "properties" => %{
          "task_id" => %{
...
| `tasks.get` | Read (detail) | "Tell me about task X", "What's the history on..." |
